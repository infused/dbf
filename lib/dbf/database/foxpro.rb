module DBF
  # DBF::FoxproDatabase is the primary interface to a Visual Foxpro database container (.dbc file).
  ...
  class FoxproDatabase
    # Opens a DBF::FoxproDatabase
    # Examples:
    #   # working with a database stored on the filesystem
    #   db = DBF::FoxproDatabase.new 'path_to_db/database.dbc'
    #
    #  # Calling a table
