...
describe DBF::Record do
  ...
  describe 'column data for table with specified source encoding' do
    let(:table) { DBF::Table.new "#{DB_PATH}/cp1251.dbf", "cp1251"}

    it 'should encodes to default system encoding' do
